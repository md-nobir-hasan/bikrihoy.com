...
{
    protected $fillable=['user_id','order_number','sub_total','quantity','delivery_charge','status','total','name','last_name','country','post_code','address','note','phone','email','payment_method','payment_status','shipping_id','coupon'];
